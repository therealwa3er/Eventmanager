...
class SubscribersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post subscribers_url, params: { subscriber: { Event_id: @subscriber.Event_id, email: @subscriber.email, name: @subscriber.name } }
    end
  ...
  test "should update subscriber" do
    patch subscriber_url(@subscriber), params: { subscriber: { Event_id: @subscriber.Event_id, email: @subscriber.email, name: @subscriber.name } }
